    ...
    internal class Popup : ToolStripDropDown
    {
        ...
        protected override void OnVisibleChanged(EventArgs e)
        {
            ...
            if (this.Visible && this.ShowingAnimation == PopupAnimations.None || !this.Visible && this.HidingAnimation == PopupAnimations.None)
                return;
            global::AfghanCalendar.PopupControl.NativeMethods.AnimationFlags animationFlags = this.Visible ? global::AfghanCalendar.PopupControl.NativeMethods.AnimationFlags.Roll : global::AfghanCalendar.PopupControl.NativeMethods.AnimationFlags.Hide;
            ...
            global::AfghanCalendar.PopupControl.NativeMethods.AnimateWindow((Control)this, this.AnimationDuration, animationFlags | (global::AfghanCalendar.PopupControl.NativeMethods.AnimationFlags)((PopupAnimations)1048575 & popupAnimations));
        }
        ...
        {
            var minmaxinfo = (NativeMethods.MINMAXINFO)Marshal.PtrToStructure(m.LParam, typeof(global::AfghanCalendar.PopupControl.NativeMethods.MINMAXINFO));
